...
foreach($student_name as $exam_no => $names)
{
    ...
    /***
    * set logo and student lmage
     *****/
    $pdf->Image('../pdf_file/Logo.jpeg', 10, 10, 25 );
    $pdf->Image('../images/soo.jpeg', 170, 10, 25 );
    $pdf->Ln(10);
    ...
    $pdf->Cell(150,6, $yearTitle, 0, 1, 'R');
    $pdf->Cell(130, 6, $admisTitle, 0,0,'L');
    $pdf->Cell(70, 6, $setTitle, 0,1);
    $pdf->Ln(10);

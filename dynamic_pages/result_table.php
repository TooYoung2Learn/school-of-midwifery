...
$(document).ready(function(){
	$('#myRow1').append('<td width="79" rowspan="6" align="center" valign="middle" > <p>&nbsp;</p> <p id="remark"><strong>fail</strong></p> </td>');
	//var n = $('#scores').html();
	/*if(n ==2){
...
<body>
<?php 
$divStart ="<div style='height:28.8cm; width:20cm; border:2px solid #000;'>";
echo $divStart;
...
$firstParagraph ="<p align='center'> <strong> NIGER STATE COLLEGE OF NURSING SCIENCES</strong><br />
...
$gradeInformation =' <p>LETTER GRADE                   DESCRIPTION  GENERAL                    &nbsp;&nbsp;&nbsp;&nbsp; REMARKS <br />
...
$provostComment='  <p>Provost  Comment:       <strong><u> <span id="comment"></span></u></strong><u> </u></p>
  <p>&nbsp;</p>
